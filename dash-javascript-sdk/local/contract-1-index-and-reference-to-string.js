...
const doStuff = async () => {
  ...
  // Register contract
  const contractDocuments = {"note":{"type":"object","indices": [{"name":"unique0","properties":[{"abc0":"asc"}],"unique":false}],"properties":{"abc0":{"$ref":"#/$defs/regex"}},"additionalProperties":false}}
